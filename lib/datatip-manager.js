...
/// <reference path="../typings/atom-ide-community.d.ts"/>
'use babel';
...
module.exports = class DatatipManager {
  ...
  /**
   * registers a new data tip provider
   * @param {AtomIDE.DatatipProvider} provider the provider reference to be registered
   * @returns {Disposable} a disposable item reference to be triggered for clean up the registration
   */
