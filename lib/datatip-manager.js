...
module.exports = class DatatipManager {
   ...
   */
  onMouseMoveEvt (evt) {
    const pixelPosition = this.editorView.component.pixelPositionForMouseEvent(evt);
    const screenPosition = this.editorView.component.screenPositionForPixelPosition(pixelPosition);
