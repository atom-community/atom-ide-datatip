...
module.exports = class DatatipManager {
  ...
  constructor() {
    ...
    this.onMouseMoveStoppedEvt = this.onMouseMoveStoppedEvt.bind(this);
  ...
  onMouseMoveEvt (evt) {
    ...
    this.mouseMoveTimer = setTimeout(this.onMouseMoveStoppedEvt, 300, evt);
  }

  /**
   * [onMouseMoveStopped description]
   * @param  {MouseEvent} evt [description]
   * @return {any}     [description]
   */
  onMouseMoveStoppedEvt(evt) {
